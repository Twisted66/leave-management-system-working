          ...
          <div>
            ...
            <div className="mt-1">
              <Input
                ...
                className="file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 file:cursor-pointer file:text-center dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              />
              {selectedFile && (
