...
export const getEmployeeBalances = api({ expose: true, method: "GET", path: "/employees/:employeeId/balances", auth: true }, async ({ employeeId }) => {
...
export const updateBalance = api({ expose: true, method: "PUT", path: "/balances", auth: true }, async (req) => {
    const auth = getAuthData();
...
//# sourceMappingURL=leave_balances.js.map